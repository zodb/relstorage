...
class RelStorage(
    ...
    def copyTransactionsFrom(self, other, next_tid=None):
        ...
        num_txns = 0
        for _ in other.iterator(start=next_tid):
            num_txns += 1
        log.info("Copying the %s transactions.", num_txns)
        for trans in other.iterator(start=next_tid):
            txnum += 1
            num_txn_records = 0
